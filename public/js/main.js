...
function getFetch(){
    ...
    fetch(url)
        ...
        .then(data => {
            ...
            document.querySelector('.name2').innerHTML = 'Name: ' + data.sneakers.nameOfShoes.shoe2
            document.querySelector('.name3').innerHTML = 'Name: ' + data.sneakers.nameOfShoes.shoe3
